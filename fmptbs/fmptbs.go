...
func Run(c *gin.Context) {
	...
	var fmptbsEnv fmptbsEnvelope
	err = xml.Unmarshal(body, &fmptbsEnv)
	if err != nil {
	...
	c.String(200, "status code: "+fmptbsEnv.CreateBody.Security_AuthenticateReply.ProcessStatus.StatusCode+"\n")
	c.String(200, "token: "+fmptbsEnv.CreateHeader.Createsession.SecurityToken+"\n")
	c.String(200, "sequence: "+fmptbsEnv.CreateHeader.Createsession.SequenceNumber+"\n")
	c.String(200, "sessionId: "+fmptbsEnv.CreateHeader.Createsession.SessionId+"\n")
	c.String(200, "error code: "+fmptbsEnv.CreateBody.Security_AuthenticateReply.ErrorSection.ApplicationError.ErrorDetails.ErrorCode+"\n")
	c.String(200, "error cat: "+fmptbsEnv.CreateBody.Security_AuthenticateReply.ErrorSection.ApplicationError.ErrorDetails.ErrorCategory+"\n")
	c.String(200, "error own: "+fmptbsEnv.CreateBody.Security_AuthenticateReply.ErrorSection.ApplicationError.ErrorDetails.ErrorCodeOwner+"\n")
}
